...
- Next up: **X.2.6**, `determinism_flags` per compiler: the flags clang must never see on a deterministic
  library's command line. Last finished: X.2.5, the guard's test completed on clang. On the owner's word of
...
| X Cross-platform: macOS | 10 | 54 | 10 |

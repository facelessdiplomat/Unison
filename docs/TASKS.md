...
- Next up: **X.5.6**, the executables build and link on the Mac: the relay, the runner, the console, both test
  executables and the benchmarks. Last finished: X.5.5. On the owner's word of 2026-09-25 Phase X, the port to
  macOS and play between Windows and macOS, runs before Phase 4, and 3.4.5, the LAN run, stays open until X.8.2
...
| X Cross-platform: macOS | 10 | 54 | 26 |

...
- Next up: **2.8.4**, the runner's rollback statistics summary. Last finished: 2.8.3, per-frame checksum comparison in the runner.
...
| 2 Rollback session (local) | 8 | 41 | 38 |

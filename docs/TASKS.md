...
- Next up: **X.2.7**, `module_determinism` per compiler: every module's command line in the main build read with
  clang's spellings. Last finished: X.2.6. On the owner's word of 2026-09-25 Phase X, the port to macOS and play
...
| X Cross-platform: macOS | 10 | 54 | 11 |

...
- Next up: **2.6.6**, the periodic reliable resend of confirmed frames. Last finished: 2.6.5, checksum
  comparison and desync reports.
...
| 2 Rollback session (local) | 8 | 37 | 25 |

...
- Next up: **X.7.5**, the POSIX `ConsoleScreen`: VT sequences on a terminal, the status line once a second when
  output is redirected. Last finished: X.7.4. On the owner's word of 2026-09-25 Phase X, the port to macOS and
...
| X Cross-platform: macOS | 10 | 55 | 42 |

...
/// slowest client got, the prediction window the clients were allowed, how every client fared, how many
/// frames every client reported a checksum for, and where the clients parted ways, if they did.
struct RunOutcome
{
...
/// checksum of it, and the rollback summary; a desync without the slot of every checksum breaks a contract.

...
/// players it has and how big their inputs are, how far a client may run ahead, where its randomness
/// starts, which assets and rules it runs, and which build of the engine runs them.
